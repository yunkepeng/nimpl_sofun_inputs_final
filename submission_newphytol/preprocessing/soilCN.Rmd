 ...
 * Merge this grid data (for SUID) with HULL.csv (for SUID and soil CN), so that each grid has soil C/N data - based on weighted-sum method (see below PROP calculation) in top layer (20-60cm)
 * Resample 1/6 resolution to half resolution (no need for cdo!)
 * Using knn method to fill all grids (training data 59801; testing data 5428)
...
res(soil)
#original resolution is 0.008333333 (1/120), now we convert to 20 times coarser, that is 1/6.
