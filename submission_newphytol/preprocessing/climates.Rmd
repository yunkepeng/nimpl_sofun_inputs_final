...
Tg is growth temperature (degree celcius). We used the 37 yrs average data (1980-2016), which was originally derived from monthly maximum temperature (Tmx) and minimum temperature (Tmn) from CRU ts 4.01. See formula below:
...
vpd is vapor-pressure-deficient (kPa). We used the 37 yrs average data (1980-2016), which was originally derived from monthly data from CRU ts 4.01. See formula below (Peng et al. 2020 New Phytologist):
...
output_PPFD <- monthly_radi[,3:(total_month+2)]*0.5*4.6 +output_Tg - output_Tg # here + Tg - Tg means it considered growth seasons' month 
