...
SP_input <- read.csv(file="/Users/yunpeng/data/leaf_traits/combined_leaf_traits_updated.csv") #new one sss

#remove bahar, as repeated to atkin
...
save(nre_model, file = "/Users/yunpeng/data/NPP_final/statistical_model/nre_model.RData")
