...
p1 <- ggplot(data=NPP_Forest2, aes(x=pred_gpp_c3, y=GPP)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,5000)+ylim(0,5000)
...
p2 <- ggplot(data=NPP_Forest2, aes(x=pred_npp, y=TNPP_1)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,2000)+ylim(0,2000)
...
p4 <-ggplot(data=NPP_Forest2, aes(x=pred_lnpp, y=NPP.foliage)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,1000)+ylim(0,1000)
...
p5 <-ggplot(data=NPP_Forest2, aes(x=pred_wnpp, y=NPP.wood)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,1500)+ylim(0,1500)
...
p7 <-ggplot(data=NPP_Forest2, aes(x=pred_lnf, y=lnf_obs_org)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,35)+ylim(0,35)
...
p8 <- ggplot(data=sitemean, aes(x=pred_leafn, y=obs_leafn)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,0.06)+ylim(0,0.06)
...
p9 <- ggplot(data=NRE_climate, aes(x=pred_nre, y=nre)) + #xlim(c(0.25,1))+ylim(c(0.25,1))+
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,1)+ylim(0,1)
...
p10 <- ggplot(data=Nmin_forest, aes(x=pred_nuptake, y=Nmin)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,25)+ylim(0,25)
...
p11 <- ggplot(NPP_grassland_final4, aes(x=weightedgpp_all, y=GPP)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,3000)+ylim(0,3000)
...
p12 <-ggplot(NPP_grassland_final4, aes(x=pred_npp, y=TNPP_1)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,2500)+ylim(0,2500)
...
p14 <-ggplot(NPP_grassland_final4, aes(x=pred_lnf, y=lnf_obs_final)) +
  ...
  stat_cor(aes(label = paste(..rr.label..)),size=5)+xlim(0,40)+ylim(0,40)
...
plot_grid(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14, labels = c('(a)','(b)','(c)','(d)','(e)','(f)','(g)','(h)',
                                                                      '(i)','(j)','(k)','(l)','(m)','(n)'),label_x = 0.9,label_y=0.92)
